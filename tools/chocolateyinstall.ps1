...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-739-0.msi'
$version = [version]'6.0.739.0'
...
$packageArgs = @{
    ...
    checksum       = '36e1ee83e03e7b46fb52138535e6c7877656e506697ac97855fc17cf6efbd0d7'
    checksumType   = 'sha256'

...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-697-0.msi'
$version = [version]'6.0.697.0'
...
$packageArgs = @{
    ...
    checksum       = 'b09e92ee3de15f02ed147e065ff843349cd0553a05cfe51b70c9351f17b9217f'
    checksumType   = 'sha256'

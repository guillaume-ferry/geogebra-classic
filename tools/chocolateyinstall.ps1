...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-662-0.msi'
$version = [version]'6.0.662.0'
...
$packageArgs = @{
    ...
    checksum       = '3338FCF959900E42CF7378C8F31474F13D17CD7DD3A3B35EA0D5F00088F93228'
    checksumType   = 'sha256'

...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-683-0.msi'
$version = [version]'6.0.683.0'
...
$packageArgs = @{
    ...
    checksum       = '6a01065dd5d7665828e36a937b40c45d643ce81bda31dd65007c3134477e6968'
    checksumType   = 'sha256'

...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-704-0.msi'
$version = [version]'6.0.704.0'
...
$packageArgs = @{
    ...
    checksum       = '91178dee3bbb45f8f8780a35520d95b9b52d4e04e85f41450cd10b087ecd98ee'
    checksumType   = 'sha256'

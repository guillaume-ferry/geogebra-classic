...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-713-0.msi'
$version = [version]'6.0.713.0'
...
$packageArgs = @{
    ...
    checksum       = '1da2a58da22e2eb6e08a3dfcec1a47746c3738361a09338399445a029a2aec2b'
    checksumType   = 'sha256'

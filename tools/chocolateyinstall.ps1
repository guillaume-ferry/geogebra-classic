...
$url        = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-592-0.msi'
$version    = [version]'6.0.592.0'
...
$packageArgs = @{
  ...
  checksum      = '14be9b8698cb4e06794fc51d13147445c39722ec2bfc4d01c9b6dbef9f73caca'
  checksumType  = 'sha256'

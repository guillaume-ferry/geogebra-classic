...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-709-0.msi'
$version = [version]'6.0.709.0'
...
$packageArgs = @{
    ...
    checksum       = '19aed6d4b0a0d6976c2237ed20050b848ea36f2301ec6c619306a2e023a7ec75'
    checksumType   = 'sha256'

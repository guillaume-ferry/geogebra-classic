...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-715-0.msi'
$version = [version]'6.0.715.0'
...
$packageArgs = @{
    ...
    checksum       = 'df44059346c25a7e2516bd5f800b58930a5754f705eb4a5ccbc768fc6030c6be'
    checksumType   = 'sha256'

...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-694-0.msi'
$version = [version]'6.0.694.0'
...
$packageArgs = @{
    ...
    checksum       = '51fe411ed5d7e3e9bff708cf16915369bd9d086436b04141745485358e96a336'
    checksumType   = 'sha256'

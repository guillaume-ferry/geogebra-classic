...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-654-0.msi'
$version = [version]'6.0.654.0'
...
$packageArgs = @{
    ...
    checksum       = '5e60057a4fdf8602354fed976ab5531d4c417fa30959d852fb5f02c59a4ec7f9'
    checksumType   = 'sha256'

...
$url        = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-581-0.msi'
$version    = '6.0.581.0'
...
$packageArgs = @{
  ...
  checksum      = '2f0248ff4d48f911e1d111967f2e1f50bdddc5ea956109959937448b97d31e2e'
  checksumType  = 'sha256'

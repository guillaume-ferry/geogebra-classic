...
$url        = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-644-0.msi'
$version    = [version]'6.0.644.0'
...
$packageArgs = @{
  ...
  checksum      = '5f9a380a071c032af1dede9f5743510b6a4be599f127b0ac4de3d14fcc86f897'
  checksumType  = 'sha256'

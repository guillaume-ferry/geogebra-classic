...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-729-0.msi'
$version = [version]'6.0.729.0'
...
$packageArgs = @{
    ...
    checksum       = '2024b2e134f25214d46385301feb76768f5d7f08a71b98ed4f115f504a673626'
    checksumType   = 'sha256'

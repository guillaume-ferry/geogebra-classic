...
$url        = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-598-0.msi'
$version    = [version]'6.0.598.0'
...
$packageArgs = @{
  ...
  checksum      = 'bf023183dd5252f0b0ab3f0de0ae904242ca47efdefa49ccd4b0b607854a7bb5'
  checksumType  = 'sha256'

...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-744-0.msi'
$version = [version]'6.0.744.0'
...
$packageArgs = @{
    ...
    checksum       = '1991815db4eea9ddaae88e50d6ccf94a08d55c9ca3bbe4f96286c817046f0cd0'
    checksumType   = 'sha256'

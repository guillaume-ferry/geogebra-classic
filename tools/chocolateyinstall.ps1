...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-689-0.msi'
$version = [version]'6.0.689.0'
...
$packageArgs = @{
    ...
    checksum       = '5c5b2a31cf4e8512797f550c1f3fe6b78f2b706dc7dc194d6128032016dd8034'
    checksumType   = 'sha256'

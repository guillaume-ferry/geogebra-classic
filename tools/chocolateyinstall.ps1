...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-732-0.msi'
$version = [version]'6.0.732.0'
...
$packageArgs = @{
    ...
    checksum       = 'dab64dcfb8dfc16440c94ff9a856e1459d1c124a3369619559c0505033b56287'
    checksumType   = 'sha256'

...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-691-0.msi'
$version = [version]'6.0.691.0'
...
$packageArgs = @{
    ...
    checksum       = 'b278720af604284ae174dd096607882fc5fd281e0cfd43cfa4f973018e23be83'
    checksumType   = 'sha256'

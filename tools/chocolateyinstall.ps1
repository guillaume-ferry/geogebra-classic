...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-693-0.msi'
$version = [version]'6.0.693.0'
...
$packageArgs = @{
    ...
    checksum       = '34001bc7444dc79cb259e1f0f489dff2d3efdeaed30cdbaa7221ee7a97b52488'
    checksumType   = 'sha256'

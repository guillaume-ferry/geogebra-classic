...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-680-0.msi'
$version = [version]'6.0.680.0'
...
$packageArgs = @{
    ...
    checksum       = 'b888151ef2b58ea78db664ec8bb53c181903b541804d2c309015fe4475608ca2'
    checksumType   = 'sha256'

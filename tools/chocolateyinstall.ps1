...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-749-0.msi'
$version = [version]'6.0.749.0'
...
$packageArgs = @{
    ...
    checksum       = '05027eeb0972bb2d6e9fd11beb268e46194c0b4b368533261ab01c9065a17f48'
    checksumType   = 'sha256'

...
$url        = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-637-0.msi'
$version    = [version]'6.0.637.0'
...
$packageArgs = @{
  ...
  checksum      = '4197194471DB04D7B5AF6494BA9B06E838BC80E9C898998658448B8CCD398B68'
  checksumType  = 'sha256'

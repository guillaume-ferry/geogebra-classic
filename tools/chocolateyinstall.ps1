...
$url        = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-604-0.msi'
$version    = [version]'6.0.604.0'
...
$packageArgs = @{
  ...
  checksum      = 'bb51bba3d5525d4c2cebec9c7b6e42277fbc2d035a11b98d936a0bc3139b0b4f'
  checksumType  = 'sha256'

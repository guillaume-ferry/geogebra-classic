...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-703-0.msi'
$version = [version]'6.0.703.0'
...
$packageArgs = @{
    ...
    checksum       = 'cca69ee2b24689ad733e1576ba0ddd1e56cdbfec3121ee3f487aa0c984a08de3'
    checksumType   = 'sha256'

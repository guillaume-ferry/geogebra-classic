...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-668-0.msi'
$version = [version]'6.0.668.0'
...
$packageArgs = @{
    ...
    checksum       = 'dba4290533cdd48a9e56cf80d58b565b3cfcb57f2c0695ba2bcce4e505dd20af'
    checksumType   = 'sha256'

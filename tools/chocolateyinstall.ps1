...
$url        = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-560-0.msi'
$version    = '6.0.560.0'
...
$packageArgs = @{
  ...
  checksum      = 'D2BF25F45E4247B38C242D6FB478B6646A9B0297B108C4D40629E172153EA889'
  checksumType  = 'sha256'

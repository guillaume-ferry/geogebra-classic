...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-735-0.msi'
$version = [version]'6.0.735.0'
...
$packageArgs = @{
    ...
    checksum       = '8a391e40e206ef5fbc975b5e82a79d3c3f328881b575ce3c1dfaef07fa6b6112'
    checksumType   = 'sha256'

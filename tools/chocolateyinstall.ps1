...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-745-0.msi'
$version = [version]'6.0.745.0'
...
$packageArgs = @{
    ...
    checksum       = 'A3ADD117B9EB3C7DE60B820F2790EE2AEE1B98B2828C1838150E6846A009AD43'
    checksumType   = 'sha256'

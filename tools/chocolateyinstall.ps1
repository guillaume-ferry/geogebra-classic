...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-720-0.msi'
$version = [version]'6.0.720.0'
...
$packageArgs = @{
    ...
    checksum       = '4d4e026601a35e90883023e1c4e21b093b8edf67c37f1dced5838b2f39bf5550'
    checksumType   = 'sha256'

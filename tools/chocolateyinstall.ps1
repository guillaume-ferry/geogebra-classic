...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-741-0.msi'
$version = [version]'6.0.741.0'
...
$packageArgs = @{
    ...
    checksum       = 'c84b32deea11d50804ff23c93e741846787d665729790b9973427aaca9fc986c'
    checksumType   = 'sha256'

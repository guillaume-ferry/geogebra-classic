...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-702-0.msi'
$version = [version]'6.0.702.0'
...
$packageArgs = @{
    ...
    checksum       = '606013c8ca98945da221c2a670a02ec823b53150672906609e2bba13323ba899'
    checksumType   = 'sha256'

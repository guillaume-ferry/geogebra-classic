...
$url        = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-559-0.msi'
$version    = '6.0.559.0'
...
$packageArgs = @{
  ...
  checksum      = '3A9DE71421F42CCA033D30212996080A8DC36ABC293565904D05EEC9B27D0379'
  checksumType  = 'sha256'
    ...
    $checkreg | ForEach-Object {
        if ($null -ne $_.PSChildName) {
            if ($_.DisplayVersion.Replace('.', '') -lt $InstallerVersion) {
                ...
                Write-Output "Geogebra Classic $version already installed, skip download and install"
            }
        }
    }
}

...
$url        = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-599-0.msi'
$version    = [version]'6.0.599.0'
...
$packageArgs = @{
  ...
  checksum      = '4c1a899bb288752fa77da5f99e7b0e5802f5be86cc06f3ad9cb026862d44aea2'
  checksumType  = 'sha256'

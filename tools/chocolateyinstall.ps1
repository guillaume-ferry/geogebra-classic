...
$url        = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-574-0.msi'
$version    = '6.0.574.0'
...
$packageArgs = @{
  ...
  checksum      = 'a0bdfabf4efce56497020510f58c542b211865aae34c6f582d93f56d2b8e747a'
  checksumType  = 'sha256'

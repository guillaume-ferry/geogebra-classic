...
$url        = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-646-0.msi'
$version    = [version]'6.0.646.0'
...
$packageArgs = @{
  ...
  checksum      = '24753182c1515ef3aa59cd189e82e53de61cd2fb10dcf4bbb58466bb3815bc00'
  checksumType  = 'sha256'

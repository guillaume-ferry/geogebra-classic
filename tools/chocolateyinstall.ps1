...
$url        = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-605-0.msi'
$version    = [version]'6.0.605.0'
...
$packageArgs = @{
  ...
  checksum      = 'a78309ab88977ed5431368464c06e681ea24a2f09bed673da674c59156aa3a9b'
  checksumType  = 'sha256'

...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-664-0.msi'
$version = [version]'6.0.664.0'
...
$packageArgs = @{
    ...
    checksum       = '57e462a2633e4437c5b8c879983dcd467cd3f5b355fe9797900e19726104a567'
    checksumType   = 'sha256'

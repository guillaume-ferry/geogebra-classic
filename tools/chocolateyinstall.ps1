...
$url        = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-603-0.msi'
$version    = [version]'6.0.603.0'
...
$packageArgs = @{
  ...
  checksum      = 'e899806770dac4d2beb47c6d4e1e2ae7965a9793411a8146c3364489463d09ef'
  checksumType  = 'sha256'

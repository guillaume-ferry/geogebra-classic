...
$url = 'https://download.geogebra.org/installers/6.0/GeoGebra-Windows-Installer-6-0-686-0.msi'
$version = [version]'6.0.686.0'
...
$packageArgs = @{
    ...
    checksum       = '02b50ac1a52e68f209ca5c6177438471dfb263ef8ddfd8258104ce8f6153f75c'
    checksumType   = 'sha256'
